...
// };
// console.log(process.env.DB_DATABASE,process.env.DB_HOST,process.env.DB_USER,process.env.DB_PASS);
...
// app.post('/auth/kakao', passport.authenticate('kakao'), (request, res) => {
//     console.log("res :",res)
// });
...
// app.post('/auth/kakao/callback', passport.authenticate('kakao', {
//     failureRedirect : '/',
// }), (req, res) => {
//     // res.redirect('/')
