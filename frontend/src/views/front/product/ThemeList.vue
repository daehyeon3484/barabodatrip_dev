<template>
  <main class="mt-1"> 
    <div class="continer">
            ...
            <a @click="goToDetail(product.prod_id,product.prod_type)">
              <div class="card mb-3" >
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <div :class="isMobile == true ? 'mobile-lg' : ''"><p class="card-title">{{product.prod_title}}</p></div>
                      <!-- <div :class="isMobile == true ? 'mobile-md' : ''"><p class="card-text" v-html="product.prod_desc"></p></div> -->
                      ...
                      <div :class="isMobile == true ? 'mobile-lg' : ''"><p  class="small-text">{{getCurrencyFormat(product.prod_price)}} {{product.prod_price_tp}}</p></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="productList.length < 1" :class="isMobile == true ? 'mobile-nodata-height' : 'pc-nodata-height'"></div>
    </div>
