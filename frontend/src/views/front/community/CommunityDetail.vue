      ...
      <div class="col-md-12 col-padding">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="col d-grid p-1">
            <button v-if="eventFlag" type="button" @click="goPage('event')" :class="isMobile == true ? 'btn btn-info col-auto btn-st-sm' : 'btn btn-info col-auto btn-st-md'">{{ $t("common.event_input") }}</button>
...
export default {
  ...
  methods: {
    async getCommunityInfo () {
      ...
      this.eventFlag = isDEmpty(this.communitys.event_id) ? false : true
