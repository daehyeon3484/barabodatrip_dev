          ...
          <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body"><!-- :data-bs-dismiss=items[0].offcanvas -->
              ...
              <form class="d-flex d-grid gap-2 d-md-flex mt-2">
                ...
                <button class="btn btn-info btn-sm" type="button" data-bs-dismiss="offcanvas" @click="emailTest">이메일</button>
              </form>
...
export default {
  ...
  methods : {
    ...
    getLangChange() {
      ...
      // this.lang = locale
      this.lang = 'ko'
      sessionStorage.set('locale',this.lang)
    ...
    emailTest() {
      window.location.href='/smtp/email'
    },
    async logout() {
    ...
    // },
    // async goAdminChk(){
    //   this.userChk = await this.$api("/api/memInfo", {param:[this.user.mem_id]});
    //   this.admChk = await this.$api("/api/adminChk", {param:[{adm_id : this.user.mem_id}]});
    // },
    goPrivacy(gubun) {
      let path = "";
      if(gubun == "policy") {
